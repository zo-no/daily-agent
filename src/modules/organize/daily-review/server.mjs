...
import { chronologicalReviewEntries, normalizeDailyReviewOutput } from "./model.mjs";
...
export async function reviewWithDeepSeek(input, {
  ...
  try {
    ...
    throw toDeepSeekRouteError(error, {
      invalidOutput: { code: "AI_RESPONSE_INVALID", message: "model returned invalid daily review JSON" },
