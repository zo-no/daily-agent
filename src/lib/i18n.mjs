...
Object.assign(EN, {
  ...
  "settings.googleCalendarUnavailable": "Not configured",
  ...
  "settings.googleCalendarSetup": "Add NEXT_PUBLIC_GOOGLE_CALENDAR_CLIENT_ID and enable Google Calendar API.",
...
Object.assign(ZH, {
  ...
  "settings.googleCalendarUnavailable": "尚未配置",
  ...
  "settings.googleCalendarSetup": "请配置 NEXT_PUBLIC_GOOGLE_CALENDAR_CLIENT_ID，并启用 Google Calendar API。",
...
Object.assign(EN, {
  ...
  "agent.wakeHint": "Tap to review today's notes",
...
Object.assign(EN, {
  ...
  "insights.chartEmpty": "No records in this window",
