...
const EN = {
  ...
  "entry.quickEdit": "Quick edit: {content}",
...
const ZH = {
  ...
  "entry.adjustTime": "微调时间 {time}", "entry.editContent": "编辑记录：{content}", "entry.quickEdit": "快速编辑：{content}", "entry.quickEditField": "编辑记录内容", "entry.noTime": "无时间", "entry.timeEditorTitle": "微调记录时间", "entry.timeInvalid": "请选择有效时间。",
