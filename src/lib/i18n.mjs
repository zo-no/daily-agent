...
const ZH = {
  ...
  "toast.writeSomething": "先写下一点内容", "toast.required": "请填写{field}", "toast.recordUpdated": "记录已更新", "toast.recordAdded": "已记下", "toast.recordDeleted": "记录已删除", "toast.keepCategory": "至少保留一个分类", "toast.exported": "Markdown 已导出", "toast.exportedAll": "全部 Markdown 已导出", "toast.backupExported": "完整备份已导出", "toast.backupRestored": "备份已恢复", "toast.restoreFailed": "备份恢复失败", "toast.markdownReset": "Markdown 格式已恢复默认", "toast.fixedNameRequired": "请填写固定项名称", "toast.fixedValueRequired": "请填写当前值", "toast.emptyRecordDeleted": "空记录已删除", "toast.loadFailed": "本地数据读取失败，已使用初始设置", "toast.saveFailed": "本地数据保存失败，请在关闭页面前导出备份。",
