...
Object.assign(EN, {
  ...
  "settings.appTitle": "Add to Home Screen",
  "settings.appDescription": "Open Log Note from your phone like an app. After the first load, it also works offline.",
  "settings.installTip": "Open your browser’s Share menu, then choose “Add to Home Screen”.",
...
Object.assign(ZH, {
  ...
  "settings.installTip": "打开浏览器的分享菜单，然后选择“添加到主屏幕”。",
...
Object.assign(EN, {
  ...
  "settings.mobileGeneralDetail": "Language and app access",
  "settings.mobileDownloadDetail": "Save files from Log Note",
  "settings.mobileDownloadStatus": "{count} records",
  "settings.mobileRestoreDetail": "Import a backup file",
  "settings.mobileImagesDetail": "Review local images",
  "settings.mobileImagesStatus": "{count} images · {size}",
  "settings.mobileImagesPending": "Checking images…",
  "settings.generalTitle": "General",
  "settings.generalDescription": "Language and app access.",
  ...
  "settings.downloadTitle": "Download",
  "settings.downloadDescription": "Save records, backups, or structure as files.",
  "settings.recordsGroupTitle": "Records",
  "settings.recordsGroupDescription": "Readable files for reviewing or archiving.",
  ...
  "settings.downloadFormatDescription": "Adjust how record files are arranged.",
  "settings.backupsGroupTitle": "Backup",
  "settings.backupsGroupStatus": "This browser · {records} records · {images} images",
  "settings.backupsGroupHint": "Download a complete backup before clearing browser data or moving to another device.",
  "settings.downloadCompleteBackup": "Complete backup",
  "settings.downloadTextBackup": "Text backup",
  "settings.structureGroupTitle": "Record structure",
  "settings.structureGroupDescription": "Files for reusing your categories and templates.",
  ...
  "settings.restoreDescription": "Import a backup file.",
  "settings.restoreWarningTitle": "Current data will be replaced",
  "settings.restoreWarningDescription": "Download a complete backup first. Text backups do not contain image files.",
  "settings.restorePortable": "Restore from complete backup",
  "settings.restorePortableDetail": "Checks the file, then restores records, settings, and images",
  "settings.restoreJson": "Restore from text backup",
  "settings.restoreJsonDetail": "Checks the file, then restores records and settings without image files",
  "settings.exportPortableDetail": "Records, plans, structure, settings, and local images",
  "settings.exportJsonDetail": "Records, plans, structure, and settings — no image files",
  "settings.exportStructureDetail": "Domains, categories, recording methods, order, and download format — no records",
  "settings.exportGeneralTemplateDetail": "An editable starter structure with no records",
  "settings.imagesTitle": "Images",
  "settings.imagesDescription": "Review image use and remove files no saved record uses.",
  "settings.imageStorageTitle": "Image use",
  "settings.imagesBoundaryTitle": "Current browser only",
  "settings.imagesBoundaryDescription": "Images do not sync automatically. A complete backup includes them."
});
...
Object.assign(ZH, {
  ...
  "settings.mobileGeneralDetail": "语言与桌面入口",
  "settings.mobileDownloadDetail": "从 Log Note 保存文件",
  "settings.mobileDownloadStatus": "{count} 条记录",
  "settings.mobileRestoreDetail": "导入备份文件",
  "settings.mobileImagesDetail": "查看本地图片",
  "settings.mobileImagesStatus": "{count} 张 · {size}",
  "settings.mobileImagesPending": "正在读取图片…",
  "settings.generalTitle": "常规",
  "settings.generalDescription": "界面语言与桌面入口。",
  "settings.languageDescription": "只改变界面，不会翻译或改写记录。",
  "settings.appDescription": "从手机桌面直接打开，离线时也可使用。",
  "settings.downloadTitle": "下载",
  "settings.downloadDescription": "把记录、备份或结构保存为文件。",
  "settings.recordsGroupTitle": "记录",
  "settings.recordsGroupDescription": "用于阅读或归档的记录文件。",
  "settings.recordDownloads": "记录下载",
  "settings.downloadToday": "下载今天",
  "settings.downloadAll": "下载全部",
  "settings.downloadFormatTitle": "下载格式",
  "settings.downloadFormatDescription": "调整记录文件的排列方式。",
  "settings.backupsGroupTitle": "备份",
  "settings.backupsGroupStatus": "当前浏览器 · {records} 条记录 · {images} 张图片",
  "settings.backupsGroupHint": "换设备或清除浏览器数据前，请先下载完整备份。",
  "settings.downloadCompleteBackup": "完整备份",
  "settings.downloadTextBackup": "文字备份",
  "settings.structureGroupTitle": "记录结构",
  "settings.structureGroupDescription": "用于复用分类和记录方式的文件。",
  "settings.downloadCurrentStructure": "下载当前结构",
  "settings.downloadStarterExample": "下载起步示例",
  "settings.restoreTitle": "恢复",
  "settings.restoreDescription": "导入备份文件。",
  "settings.restoreWarningTitle": "将替换当前数据",
  "settings.restoreWarningDescription": "恢复前建议先到“下载”保存完整备份；文字备份不包含图片。",
  "settings.restorePortable": "从完整备份恢复",
  "settings.restorePortableDetail": "校验文件后恢复记录、设置和图片",
  "settings.restoreJson": "从文字备份恢复",
  "settings.restoreJsonDetail": "校验文件后恢复记录与设置，不包含图片文件",
  "settings.exportPortableDetail": "包含记录、计划、结构、设置和本地图片",
  "settings.exportJsonDetail": "包含记录、计划、结构和设置，不包含图片文件",
  "settings.exportStructureDetail": "包含领域、分类、记录方式、顺序和下载格式，不包含记录",
  "settings.exportGeneralTemplateDetail": "可编辑的通用结构示例，不包含记录",
  "settings.imagesTitle": "图片",
  "settings.imagesDescription": "查看图片占用并清理未被记录使用的文件。",
  "settings.imageStorageTitle": "图片占用",
  "settings.imagesBoundaryTitle": "仅当前浏览器",
  "settings.imagesBoundaryDescription": "图片不会自动同步；完整备份会包含图片。"
});
...
Object.assign(EN, {
  ...
  "settings.accountDescription": "This account owns the records on this device and their cloud copy.",
  "settings.accountPasswordTitle": "Email and password",
  "settings.accountPasswordDescription": "Use an email account when Google is inconvenient. Passwords are handled by Supabase Auth and are never stored in Log Note data.",
  ...
  "settings.accountCloudDescription": "Changes are saved on this device first, then automatically sent to Supabase. Another account cannot read this cache.",
  ...
  "settings.cloudTextOnly": "Text records, plans, structure, and settings sync automatically. Images remain only on this device and in complete backups.",
  ...
  "settings.googleCalendarDescription": "Log Note plans sync to your primary calendar. Existing Google events appear here as read-only context.",
  ...
  "settings.googleCalendarBoundary": "Only marked Log Note events can be changed. Google access stays in this page and is not included in backups.",
  ...
  "auth.callbackWorkingDetail": "Log Note is confirming the Google account for this browser.",
...
Object.assign(ZH, {
  ...
  "settings.accountDescription": "这个账号拥有本设备上的记录及对应云端副本。",
  "settings.accountPasswordTitle": "邮箱和密码",
  "settings.accountPasswordDescription": "Google 不方便时可直接使用邮箱账号。密码由 Supabase Auth 处理，不会写入 Log Note 数据。",
  ...
  "settings.accountCloudDescription": "修改会先保存在本设备，再自动发送到 Supabase；其他账号无法读取这份缓存。",
  ...
  "settings.cloudTextOnly": "文字记录、日计划、结构和设置会自动同步；图片仍只在本设备和完整备份中。",
  ...
  "settings.googleCalendarDescription": "Log Note 计划会同步到主日历；Google 中原有事件只作为只读时间背景。",
  ...
  "settings.googleCalendarBoundary": "只有 Log Note 标记的事件可以被修改；Google 授权仅保留在当前页面，不进入备份。",
  ...
  "auth.callbackWorkingDetail": "Log Note 正在为此浏览器确认 Google 账号。",
