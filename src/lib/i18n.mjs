...
Object.assign(EN, {
  ...
  "insights.chartLabel": "{domain}, record activity over 30 days",
...
Object.assign(ZH, {
  ...
  "insights.records": "记录",
  "insights.activeDays": "活跃日",
  "insights.ordinaryRecords": "普通记录",
  "insights.periodicRecords": "周期记录",
  "insights.activityTitle": "记录节律",
  "insights.chartLabel": "{domain}最近 30 天的记录活动",
  "insights.chartSummary": "{firstDate}：{first}；{middleDate}：{middle}；{lastDate}：{last}",
