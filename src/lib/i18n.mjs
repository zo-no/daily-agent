...
Object.assign(EN, {
  ...
  "settings.googleCalendarVerificationNote": "Google may still show an unverified-app warning until this OAuth client completes Calendar scope verification.",
...
Object.assign(ZH, {
  ...
  "settings.googleCalendarVerificationNote": "在当前 OAuth 客户端完成 Google 日历权限校验前，Google 仍可能显示“未验证应用”提示。",
