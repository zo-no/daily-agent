...
Object.assign(EN, {
  ...
  "settings.googleCalendarVerificationNote": "If Google says this account cannot use the app, the OAuth project is usually still in Testing and the account is not a test user. This is Google access control, not a Log Note account rollout.",
...
Object.assign(ZH, {
  ...
  "settings.googleCalendarVerificationNote": "如果 Google 提示“此账号无法使用应用”，通常表示 OAuth 项目仍在测试，且该账号未加入测试用户。这是 Google 的访问控制，不是 Log Note 账号灰度。",
