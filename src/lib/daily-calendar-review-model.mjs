...
import { AiClassifierError } from "./ai-route-boundary.mjs";
...
const toMinutes = (value) => validTime(value) ? Number(String(value).slice(0, 2)) * 60 + Number(String(value).slice(3)) : null;
